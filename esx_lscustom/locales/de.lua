Locales['de'] = {
  ...
  ['already_own'] = 'Du besitzt es bereits: ~b~%s~s~',
  ['not_enough_money'] = 'Du kannst es dir nicht leisten!',
  ['purchased'] = 'Du hast diese Modifikation gekauft!',
...
-- Cosmetics
  ...
  ['modplateholder'] = 'Schild - hinten',
  ['modvanityplate'] = 'Schild - vorne',
  ['interior'] = 'Innenraum',
  ['trim'] = 'Trim',
  ['dashboard'] = 'Dashboard',
  ['speedometer'] = 'Tachometer',
  ['door_speakers'] = 'Lautsprecher Tür',
  ['seats'] = 'Sitze',
