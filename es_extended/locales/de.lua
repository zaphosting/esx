Locales['de'] = {
  ...
  -- Commands
  ['setjob'] = 'Einen User einen Job zuweisen',
  ['id_param'] = 'Die ID vom Spieler',
  ['setjob_param2'] = 'Den Job welchen du zuweisen moechtest',
  ['setjob_param3'] = 'Das Job Level',
  ['load_ipl'] = 'Lade IPL',
  ['unload_ipl'] = 'entlade IPL',
  ['play_anim'] = 'Spiele Animation',
  ['play_emote'] = 'Geste spielen',
  ['spawn_car'] = 'Auto spawnen',
  ['spawn_car_param'] = 'Name vom Auto',
  ['delete_vehicle'] = 'Auto entfernen',
  ['spawn_object'] = 'Objekt spawnen',
  ['spawn_ped'] = 'Spawne NPC',
  ['spawn_ped_param'] = 'Beispiel: a_m_m_hillbilly_01',
  ['givemoney'] = 'Geld geben',
  ['setmoney'] = 'Geld setzen fuer einen Spieler',
  ['money_type'] = 'Gueltige Geldarten: cash, bank, black',
  ['money_set'] = 'Jemand hat dir gerade ~g~$%s~s~ (%s) gespendet!',
  ['money_amount'] = 'Menge',
  ['invalid_account'] = 'Invalides Konto',
  ['account'] = 'Konto',
  ['giveaccountmoney'] = 'Geld auf das Konto einzahlen',
  ['invalid_item'] = 'Invalider Gegenstand',
  ['item'] = 'Gegenstand',
  ['giveitem'] = 'Gegenstand geben',
  ['weapon'] = 'Waffe',
  ['giveweapon'] = 'Waffe geben',
  ['disconnect'] = 'Verlasse den Server',
  ['chat_clear'] = 'Setze den chat zurueck',
  ['chat_clear_all'] = 'Setze den Chat fuer jeden zurueck',
  ['command_clearinventory'] = 'Entferne jeden Gegenstand aus dem Inventar',
  ['command_clearloadout'] = 'Entferne jede Waffe aus dem Loadout',
  ['command_playerid_param'] = 'SpielerID angeben oder fuer sich selbst leer lassen',
  -- Locale settings
  ...
  ['component_clip_drum'] = 'Trommel Magazine',
  ...
  ['component_luxary_finish'] = 'luxuriöses Waffen-Finish',
}
